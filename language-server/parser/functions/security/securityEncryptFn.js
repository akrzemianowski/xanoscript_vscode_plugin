...
import { EncryptToken } from "../../../lexer/security.js";
import { Identifier, NewlineToken } from "../../../lexer/tokens.js";

/**
 * @param {import('../../base_parser.js').XanoBaseParser} $
 */
export function securityEncryptFn($) {
  return () => {
    $.sectionStack.push("securityEncryptFn");
    const fnToken = $.CONSUME(EncryptToken); // "encrypt"
    $.CONSUME(LCurly); // "{"
    $.MANY(() => {
