      ...
      $.OR([
        {
          ...
          ALT: () => {
            $.AT_LEAST_ONE_SEP({
              ...
              DEF: () => {
                $.OR1([
                  { ALT: () => (identifier = $.CONSUME(Identifier)) }, // key
                  { ALT: () => (identifier = $.CONSUME(StringLiteral)) }, // "value"
                ]);
                  ...
                  if (typeof varType === "function") {
                    ...
                    $.OR4([
                      ...
                      },
                      {
                        GATE: () => !varType,
                        ALT: () =>
                          $.SUBRULE($.valueExpression, { ARGS: [options] }), // anything goes
                      },
                    ]);
                  }
                }
        ...
        },
        {
          ...
          ALT: () => {
            ...
            $.AT_LEAST_ONE(() => {
              $.OR2([
                { ALT: () => (identifier = $.CONSUME2(Identifier)) }, // key
                { ALT: () => (identifier = $.CONSUME2(StringLiteral)) }, // "other key"
              ]);
              definedAttributes.push(identifier);
              $.CONSUME1(ColonToken);
              const varName = getVarName(identifier);
                ...
                if (typeof varType === "function") {
                  ...
                  $.OR3([
                    ...
                    },
                    {
                      GATE: () => !varType,
                      ALT: () =>
                        $.SUBRULE1($.valueExpression, { ARGS: [options] }), // anything goes
                    },
                  ]);
                }
              }
