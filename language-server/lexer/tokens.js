...
import {
  FilterTokens,
  mapTokenToType as mapFilterTokenToType,
} from "./filters.js";
import {
  FunctionTokens,
...
// accepts a path (aka containing a slash)
export const StaticPathToken = createToken({
  name: "StaticPathToken",
  label: "static_path",
  pattern: /[a-zA-Z0-9_-]+(?:\/[a-zA-Z0-9_-]+)+/,
});

// accepts a query (aka containing a slash) with optional variables
// - api/users
// - {user_id}/messages
// - v10/{user_id}/details
export const DynamicPathToken = createToken({
  name: "DynamicPath",
  label: "dynamic_path",
  pattern:
