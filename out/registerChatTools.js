...
exports.registerChatTools = void 0;
...
function registerChatTools(context) {
  context.subscriptions.push(
    vscode.lm.registerTool(
      "upload_static_files_to_xano",
      new UploadStaticFilesToXanoLm()
    )
  );
  context.subscriptions.push(
    vscode.lm.registerTool(
      "get_xano_api_specifications",
      new GetXanoApiSpecificationsLm()
    )
  );
  context.subscriptions.push(
    vscode.lm.registerTool("push_all_changes_to_xano", new PushAllChangesLm())
  );
  context.subscriptions.push(
    vscode.lm.registerTool("get_all_xano_tables", new GetAllTablesLm())
  );
  context.subscriptions.push(
    vscode.lm.registerTool(
      "get_objects_specification",
      new GetWorkspaceObjectsLm()
    )
  );
  context.subscriptions.push(
    vscode.lm.registerTool(
      "generate_xanoscript_crud_endpoint",
      new GenerateCrudEndpointLm()
    )
  );
  context.subscriptions.push(
    vscode.lm.registerTool("generate_xano_api_sdk", new GenerateXanoApiSdkLm())
  );
  context.subscriptions.push(
    vscode.lm.registerTool(
      "batch_add_records_to_xano_table",
      new BatchAddRecordsToTableLm()
    )
  );
  context.subscriptions.push(
    vscode.lm.registerTool(
      "push_current_file_to_xano",
      new InvokeFileCommandLM(
        "Push Current File to Xano",
        "xanoscript.pushFileChanges",
        "File pushed to Xano",
        "Failed to push file to Xano"
      )
    )
  );
}
...
class BatchAddRecordsToTableLm {
  invoke(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const ids = yield (0, dbo_1.batchAddRecordsToTable)(
        config_1.config.instanceName,
        config_1.config.workspaceId,
        dataSource,
        tableId,
        rows
      );
  ...
  prepareInvocation(options) {
    ...
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        (_a = options.input.invocationMessage) !== null && _a !== void 0
          ? _a
          : `Are you sure you want to add records to the specified table?`
      ),
    };
    return {
      invocationMessage:
        (_b = options.input.invocationMessage) !== null && _b !== void 0
          ? _b
...
class GetAllTablesLm {
  invoke() {
    return __awaiter(this, void 0, void 0, function* () {
      const tables = yield (0, dbo_1.fetchTables)(
        config_1.config.instanceName,
        config_1.config.workspaceId,
        false
      );
  ...
  prepareInvocation() {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Retrieve all the tables and their schema from your Xano Workspace?`
      ),
    };
    return {
...
class GenerateXanoApiSdkLm {
  invoke(options) {
    return __awaiter(this, void 0, void 0, function* () {
      const outputPath =
        options.input.outputDir || (0, path_1.join)("static", "src", "api");
      yield (0, generateSDK_1.generateSDK)(outputPath);
      return new vscode.LanguageModelToolResult([
        new vscode.LanguageModelTextPart(
          `Successfully generated Xano API SDK at ${outputPath}`
        ),
      ]);
    });
  }
  prepareInvocation(options) {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Confirm you want to generate the Xano API SDK in ${options.input.outputDir}?`
      ),
    };
    return {
...
class UploadStaticFilesToXanoLm {
  invoke(options, token) {
    return __awaiter(this, void 0, void 0, function* () {
      const upload = yield (0, static_1.uploadStaticContent)(
        config_1.config.instanceName,
        config_1.config.workspaceId,
        options.input.name,
      ...
      if (upload.custom_url) {
        return new vscode.LanguageModelToolResult([
          new vscode.LanguageModelTextPart(
            `upload successful at ${upload.custom_url}`
          ),
        ]);
      }
      return new vscode.LanguageModelToolResult([
        new vscode.LanguageModelTextPart(
          `upload successful at ${upload.default_url}`
        ),
      ]);
    });
  }
  ...
  prepareInvocation() {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Are you sure you want to upload static content?`
      ),
    };
    return {
...
class PushAllChangesLm {
  ...
  prepareInvocation() {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Are you sure you want to push all changes to Xano?`
      ),
    };
    return {
...
class GetWorkspaceObjectsLm {
  invoke(options) {
    return __awaiter(this, void 0, void 0, function* () {
      const objects = yield (0, getWorkspaceObjects_1.getWorkspaceObjects)(
...
class GetXanoApiSpecificationsLm {
  invoke() {
    return __awaiter(this, void 0, void 0, function* () {
      const apiGroups = yield (0, api_1.fetchApiGroups)(
        config_1.config.instanceName,
        config_1.config.workspaceId
      );
      const swaggerJson = [];
  ...
  prepareInvocation() {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Retrieve all backend API specifications?`
      ),
    };
    return {
...
class GenerateCrudEndpointLm {
  invoke(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new vscode.LanguageModelToolResult([
        new vscode.LanguageModelTextPart(
          `Successfully created endpoint ${options.input.action} (${options.input.table}) function`
        ),
      ]);
    });
  }
  prepareInvocation(options) {
    const confirmationMessages = {
      ...
      message: new vscode.MarkdownString(
        `Are you sure you want to create a CRUD endpoint?`
      ),
    };
    return {
...
class InvokeFileCommandLM {
  ...
  invoke(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const success = yield vscode.commands.executeCommand(
        this.command,
        options.input.path
      );
      if (!success) {
  ...
  prepareInvocation() {
    const confirmationMessages = {
      title: this.title,
      message: new vscode.MarkdownString(
        `Are you sure you want to invoke this command?`
      ),
    };
    return {
